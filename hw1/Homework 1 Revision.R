...
-60585143 + 1992*60297.0426 + (-15*(1992^2))
-60585142.983497552574 + 1992*60297.042561891837977 + (-15.000406561079099532*(1992^2))
regression_df
write.csv(regression_df, "regression_df.csv")


# just calls time in data section
regression_df1 <- regression_df[,c(1,3)]
...
plot(retails_elecronic_test - total_predictions_quartic)
abline(h = 0, col = "red")
...
RMSE_quartic <- sqrt(mean((retails_elecronic_test - total_predictions_quartic)^2))
